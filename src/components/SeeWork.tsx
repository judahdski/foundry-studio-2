...
export default function SeeWork({
    ...
    const categories = [
        ...
        { label: "Custom Web Development", value: "Custom Web Development" },
        {
            ...
            value: "Refactoring & Performance Optimization",
        },
    ...
    return (
        <section
            id="work"
            className="py-24 md:py-32 border-b border-[#2B3038] bg-[#141619] relative"
        >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                    <div className="max-w-2xl">
                        ...
                        <p className="text-base sm:text-lg text-[#8E929A] leading-relaxed">
                            We measure our work by the clarity of the
                            operational system left behind. Here is evidence of
                            real-world problems transformed into structured
                            software.
                        </p>
                    </div>
                        ...
                        >
                            <div>
                                ...
                                <div className="flex items-center justify-between pb-3 mb-4 border-b border-[#24282F] text-xs font-mono">
                                    <span className="text-[#3157D5] font-medium">
                                        {study.category}
                                    </span>
                                    <span className="text-[#8E929A] truncate max-w-[200px]">
                                        {study.clientType}
                                    </span>
                                </div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        {study.liveUrl && (
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noreferrer"
                                                className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#8E929A] hover:text-[#F2F0EA] transition-colors"
                                            >
                                                <span>Live Demo</span>
                ...
                <div className="mt-14 p-6 bg-[#1B1E22] border border-[#2B3038] rounded-sm flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
                    <p className="text-[#8E929A]">
                        <strong className="text-[#F2F0EA] block sm:inline mr-1">
                            No manufactured metrics.
                        </strong>
                        Every project represents actual code, workflows, and
                        operational systems deployed to real users.
                    </p>
                    <button
